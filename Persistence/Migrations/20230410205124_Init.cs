    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("53b08e3d-7620-4f73-87ee-0b2d2686c179"), "Обновление ПО для клиента", "Обновление ПО", "20 млн. руб", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5098), null, "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5098) },
                    { new Guid("6442d3ea-986d-4ed0-b249-6993fa75ed83"), "Разработка ПО для клиента", "Разработка ПО", "40 млн. руб", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5090), null, "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5092) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3d490a70-94ce-4d15-9494-5248280c2ce3"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(4468), "Энергопроект", "Россия", "Петр", "Васнецов", "Петрович", "energoProject@.ru", "г. Воронеж ул. Воронина 56 офис 21", "8910567890", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(4469) },
                    { new Guid("c9d4c053-49b6-410c-bc78-2d54a9991870"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(4444), "Экосистемы", "Россия", "Дмитрий", "Загородский", "Витальевич", "EcoSystem@eco.ru", "г. Москва пр. Ленина 21 офис 14", "89035678945", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(4450) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("64c2f517-4c27-4e23-adbb-70077bc80834"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6754), "Дмитрий", "Програмист", "Коренков", "Васильевич", "korenkov@prog.ru", "г.Москва пр. Маркса 21 ", "89056673245", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6756) },
                    { new Guid("d3223d1e-7ccd-4384-ac2c-734634e7b7f3"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6760), "Виталий", "Дизайнер", "Валежник", "Витальевич", "korenkov@prog.ru", "г.Уфа ул. Ленина 14 ", "89076222241", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6760) },
                    { new Guid("ec21ec2e-fc34-4235-9575-066f56c49f5f"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6763), "Андрей", "Менеджер проекта", "Паринков", "Витальевич", "parinkov@prog.ru", "г.Мытищи ул. Вологда 33", "8970545821", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6763) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("278c74e0-bfc0-48c0-8090-ee23cf303dae"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6009), null, null, "Моделирование БД для разработки по проекту ECOLine", new DateTime(2023, 4, 30, 23, 51, 24, 19, DateTimeKind.Local).AddTicks(6013), "InProcess", "12 ч", "Моделирование БД", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6010) },
                    { new Guid("38c87236-80b8-471e-bad4-24c318ba022f"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6016), null, null, "Тестирование ПО по проекту ECOLine", new DateTime(2023, 4, 24, 23, 51, 24, 19, DateTimeKind.Local).AddTicks(6019), "InProcess", "2 ч", "Тестирование ПО", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6017) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1e9c86b9-5976-4713-8c01-1601b74e9d37"), null, "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5539), "Разработка ПО, Разработка и развёртывание", new DateTime(2023, 8, 8, 0, 0, 0, 0, DateTimeKind.Local), "InProcess", "300 ч", "Разработка ПО для компании ECOTech", "Разработка ПО", null, "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5540) },
                    { new Guid("94b1f1ac-30ee-45f8-929a-ad77ca814000"), null, "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5566), "Разработка ПО, Разработка и развёртывание", new DateTime(2023, 9, 17, 0, 0, 0, 0, DateTimeKind.Local), "InProcess", "400 ч", "Разработка ПО для компании ТехноМания", "Разработка ПО", null, "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(5567) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1c29869d-49e6-4a8e-a1eb-8773497e80fe"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6419), null, "Команда укомлектована дизайнером", "Команда по проекту ТехноМания", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6419) },
                    { new Guid("9e1257c8-00d1-4ba9-80af-f84b8e29431a"), "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6414), null, "Команда укомлектована аналитиком", "Команда по проекту EcoLine", "System", new DateTime(2023, 4, 10, 20, 51, 24, 19, DateTimeKind.Utc).AddTicks(6416) }
                });
